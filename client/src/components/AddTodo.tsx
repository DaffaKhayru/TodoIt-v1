    ...
    return (
        ...
        >
            ...
            >
                {/* title */}
                <div className='py-2'>
                    <h1 className='text-2xl pl-4 font-semibold'>Add Todo</h1>
                </div>
                ...
                <form className='flex flex-col'>
                    ...
                    <div className='flex py-2 px-4  justify-between'>
                        ...
                        <button onClick={toggleAddTodo} className='hover:bg-gray-200 duration-200 bg-gray-100 p-2 cursor-pointer rounded-sm'>Cancel</button>
                    </div>
                </form>
            </motion.div>
        </motion.div>
